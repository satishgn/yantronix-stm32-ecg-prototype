...
void USB_Interrupts_Config(void)
{
  ...
  /* Set the Vector Table base location at 0x9000 */ 
...
#else /* USE_STM3210B_EVAL or USE_STM3210E_EVAL or USE_STM32_PRIMER2 */
  if (NewState != DISABLE)
  {
...
* Description    :  configure the EVAL_COM1/EVAL_COM2 with default values.
* Input          :  None.
* Return         :  None.
*******************************************************************************/
void USART_Config_Default(void)
{
  /* EVAL_COM1/EVAL_COM2 default configuration */
  /* EVAL_COM1/EVAL_COM2 configured as follow:
        - BaudRate = 9600 baud  
        - Word Length = 8 Bits
        - One Stop Bit
        - Parity Odd
...
#ifdef USE_STM32_PRIMER2
  /* Configure and enable the USART 2 */
  STM_EVAL_COMInit(COM2, &USART_InitStructure);

  /* Enable the USART 2 Receive interrupt */
  USART_ITConfig(EVAL_COM2, USART_IT_RXNE, ENABLE);
#else
  /* Configure and enable the USART 1 */
  STM_EVAL_COMInit(COM1, &USART_InitStructure);

  /* Enable the USART 1 Receive interrupt */
...
* Description    :  Configure the EVAL_COM1/EVAL_COM2 according to the linecoding structure.
* Input          :  None.
...
* Description    : send the received data from USB to the USART.
