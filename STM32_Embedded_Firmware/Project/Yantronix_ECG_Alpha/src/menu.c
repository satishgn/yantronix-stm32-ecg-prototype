...
struct sMenuItem MainMenuItems[] =
  {
	...
	{"      Shutdown      ", System_Shutdown, Menu_ReturnFunc}
  };
...
{
#ifdef GPIO_PIN_DEBOUNCE_DELAY
  Delay(GPIO_PIN_DEBOUNCE_DELAY);
#else      
  __IO uint32_t index = 0; 
  for(index = GPIO_PIN_DEBOUNCE_LOOP_COUNT; index != 0; index--);
#endif
