...
/* LCD Control pins */
#define CtrlPin_RST                 GPIO_Pin_9
#define GPIOx_LCD_CTRL_RST          GPIOB
#define GPIO_LCD_CTRL_RST_PERIPH    RCC_APB2Periph_GPIOB
#define CtrlPin_CS                  GPIO_Pin_15
#define GPIOx_LCD_CTRL_CS           GPIOA
#define GPIO_LCD_CTRL_CS_PERIPH     RCC_APB2Periph_GPIOA
#define CtrlPin_RS                  GPIO_Pin_5
#define GPIOx_LCD_CTRL_RS           GPIOB
#define GPIO_LCD_CTRL_RS_PERIPH     RCC_APB2Periph_GPIOB
#define CtrlPin_RD                  GPIO_Pin_3
#define GPIOx_LCD_CTRL_RD           GPIOB
#define GPIO_LCD_CTRL_RD_PERIPH     RCC_APB2Periph_GPIOB
#define CtrlPin_WR                  GPIO_Pin_4
#define GPIOx_LCD_CTRL_WR           GPIOB
#define GPIO_LCD_CTRL_WR_PERIPH     RCC_APB2Periph_GPIOB
...
#define CtrlPin_RS                  GPIO_Pin_2
#define GPIOx_LCD_CTRL_RS           GPIOD
#define GPIO_LCD_CTRL_RS_PERIPH     RCC_APB2Periph_GPIOD
#define CtrlPin_RD                  GPIO_Pin_12
#define GPIOx_LCD_CTRL_RD           GPIOC
#define GPIO_LCD_CTRL_RD_PERIPH     RCC_APB2Periph_GPIOC
#define CtrlPin_WR                  GPIO_Pin_8
