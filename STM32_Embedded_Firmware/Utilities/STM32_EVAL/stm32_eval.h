...
typedef enum 
{
 ...
 #include "stm32f10x.h"
 #include "stm32_primer2/stm32_primer2.h"
#elif defined USE_STM32_H103
 #include "stm32f10x.h"
 #include "stm32_h103/stm32_h103.h"
#elif defined USE_STM32_VL_DISCOVERY
 #include "stm32f10x.h"
 #include "stm32_vl_discovery/stm32_vl_discovery.h" 
#elif defined USE_STM32_SGN101 
 #include "stm32f10x.h"
 #include "stm32_sgn101/stm32_sgn101.h" 
#elif defined USE_STM32_SGN10X 
 #include "stm32f10x.h"
 #include "stm32_sgn10x/stm32_sgn10x.h"  
#else 
...
#define Line10              LCD_LINE_10
#define Line11              LCD_LINE_11
#define Line12              LCD_LINE_12
#define Line13              LCD_LINE_13
#define Line14              LCD_LINE_14
#define Line15              LCD_LINE_15

#define Column0             LCD_COLUMN_0
#define Column1             LCD_COLUMN_1
#define Column2             LCD_COLUMN_2
#define Column3             LCD_COLUMN_3
#define Column4             LCD_COLUMN_4
#define Column5             LCD_COLUMN_5
#define Column6             LCD_COLUMN_6
#define Column7             LCD_COLUMN_7
#define Column8             LCD_COLUMN_8
#define Column9             LCD_COLUMN_9
#define Column10            LCD_COLUMN_10
#define Column11            LCD_COLUMN_11
#define Column12            LCD_COLUMN_12
#define Column13            LCD_COLUMN_13
#define Column14            LCD_COLUMN_14
#define Column15            LCD_COLUMN_15
#define Column16            LCD_COLUMN_16
#define Column17            LCD_COLUMN_17
#define Column18            LCD_COLUMN_18
#define Column19            LCD_COLUMN_19
#define Column20            LCD_COLUMN_20
#define Column21            LCD_COLUMN_21
#define Column22            LCD_COLUMN_22
#define Column23            LCD_COLUMN_23
